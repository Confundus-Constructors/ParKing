    ...
    return (
        <SafeAreaView style={{ flex: 1 }}>
            <View style={styles.container}>
                <ValetInfo navigation={navigation} blur={blur}/>
            ...
            <View style={{marginTop: -10}}>
                <UploadID navigation={navigation}/>
            </View>
            ...
            >
                <SafeAreaView style={{ flex: 1, justifyContent: 'flex-start', alignItems: 'center', marginTop: 110 }}>
                    <View style={{ width: '95%', height: 540, backgroundColor: '#F7F7F7', padding: 10, borderRadius: 20 }}>
                        <Why />
                ...
                <Tab.Navigator
                 ...
                 >
                    ...
                    {userTabs.map((tab, index) => (
                     ...
                     <Tab.Screen name="+ Add Location" listeners={{
                          tabPress: e => {
                              // e.preventDefault();
                              addNewTab();
                          }
